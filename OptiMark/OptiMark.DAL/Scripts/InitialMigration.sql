...
CREATE TABLE [Reports] (
    ...
    CONSTRAINT [FK_Reports_Campaigns_CampaignId] FOREIGN KEY ([CampaignId]) REFERENCES [Campaigns] ([CampaignId]) ON DELETE CASCADE,
    CONSTRAINT [FK_Reports_Companies_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Companies] ([CompanyId]),
    CONSTRAINT [FK_Reports_Companies_CompanyId1] FOREIGN KEY ([CompanyId1]) REFERENCES [Companies] ([CompanyId]) ON DELETE CASCADE
);
...
CREATE INDEX [IX_Reports_CompanyId1] ON [Reports] ([CompanyId1]);
...
VALUES (N'20251105113047_Initial', N'9.0.10');
