...
CREATE TABLE [Reports] (
    ...
    CONSTRAINT [FK_Reports_Companies_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Companies] ([CompanyId]) ON DELETE CASCADE
);
...
VALUES (N'20251105112225_Initial', N'9.0.10');
